...
/*
 */
class SliderModule    : public Module, public juce::Slider::Listener
{
public:
    SliderModule();
    ~SliderModule();
...
private:
    ...
    {
        ValueListener (juce::Value& v, SliderModule* k) : k(k),  value (v) { value.addListener (this); }
    ...
    {
        MaxValueListener (juce::Value& v, SliderModule* k) : k(k), value (v) { value.addListener (this); }
    ...
    {
        MinValueListener (juce::Value& v, SliderModule* k) : k(k), value (v){ value.addListener (this); }
    ...
    {
        StepsizeValueListener (juce::Value& v, SliderModule* k) : k(k), value (v){ value.addListener (this); }
    ...
    {
        IsControllerValueListener (juce::Value& v, SliderModule* k) : k(k), value (v){ value.addListener (this); }
    ...
    {
        ControllerValueListener (juce::Value& v, SliderModule* k) : k(k), value (v){ value.addListener (this); }
